...
const useRequest = <ParamType = any, PromiseRequestType = any, DataType = MyResponse<PromiseRequestType>>(
  ...
  if (option.throttle && option.debounce) {
    console.warn("[ywz warn]: useRequest的配置项中的throttle和debounce均为true，请选择一个，否则这样默认使用防抖");
  }
